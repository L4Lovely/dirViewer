...
static PyCodeObject *codeobj_529c9df32fd655358731c56f6e559fe7;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[1]; CHECK_OBJECT(module_filename_obj);
    codeobj_529c9df32fd655358731c56f6e559fe7 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[393], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_529c9df32fd655358731c56f6e559fe7;
    ...
    // Frame without reuse.
    frame_529c9df32fd655358731c56f6e559fe7 = MAKE_MODULE_FRAME(codeobj_529c9df32fd655358731c56f6e559fe7, module_Xlib$keysymdef$latin1);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_529c9df32fd655358731c56f6e559fe7);
    assert(Py_REFCNT(frame_529c9df32fd655358731c56f6e559fe7) == 2);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_529c9df32fd655358731c56f6e559fe7);
#endif
    popFrameStack();

    assertFrameObject(frame_529c9df32fd655358731c56f6e559fe7);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_529c9df32fd655358731c56f6e559fe7, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_529c9df32fd655358731c56f6e559fe7->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_529c9df32fd655358731c56f6e559fe7, exception_lineno);
    }
